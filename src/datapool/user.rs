...
pub fn random_article() -> String {
    format!(
        "{}",
        fake::faker::lorem::zh_cn::Paragraph(2..10).fake::<String>()
    )
}
...
pub fn random_article_title() -> String {
    format!(
        "{}",
        fake::faker::lorem::zh_cn::Sentence(1..2).fake::<String>()
    )
}
